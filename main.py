...
if __name__ == "__main__":
    ...
    for index in range(len(test_dataset)):
        ...
        ## GT comparison ##
        parameter_results, parameter_node_scores = compare_with_gt(test_dataset,gt_graph_paths,final_paths_folder,index,plant_img,multiple_tips_paths,valid_final_paths,
                        alphas,betas,gammas,w_locals,w_globals,parameter_results,parameter_node_scores,total_combinations)
